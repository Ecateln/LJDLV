...
C'est pourquoi la génération d'une ville __(plutôt la modélisation d'une telle organisation)__ respectant certains critères donnés, à l'aide d'un outil informatique, peut s'avérer des plus utiles dans le contexte sociétal actuel.

L'utilisation d'un automate cellulaire __(plutôt semble permettre, car c'est ce que tu vas étudier)__ permet, avec une grande flexibilité, de construire un modèle de ville ainsi que de représenter et d'étudier son évolution afin d'adapter les résultats obtenus pour proposer de nouvelles règles et mieux répondre aux besoins des futurs habitants. __(phrase un peu longue, à reprendre éventuellement en parlant de l'utilisation de l'automate cellullaire pour la modélisation dont tu parles dans le paragraphes précédent)__
